...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponseDto> handleServiceUnavailable(ServiceUnavailableException ex) {
        log.warn("REST response error - Downstream service unavailable: {}", ex.getMessage());
        ErrorResponseDto errorDto = createBaseErrorResponse(HttpStatus.SERVICE_UNAVAILABLE, ex.getMessage());
